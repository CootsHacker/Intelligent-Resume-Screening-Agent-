...
向量存储请求体={
{
  "resumeId": "res_2001",
  "resumeText":{
      "baseInfo":"此部分包含个人基本信息：姓名，电话，邮箱地址，大学，专业，毕业时间",
...
def text_spliter(request_data:TextSpliter)->list:
    ...
    baseInfo=request_data.resumeText.baseInfo
    skills=request_data.resumeText.skills
    projects=request_data.resumeText.projects

    text.append(resumeId)
